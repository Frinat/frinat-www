...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'calendar_category', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['calendar.Category'])),
        ...
        db.create_unique(u'calendar_category', ['name', 'parent_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Category', fields ['name', 'parent']
        db.delete_unique(u'calendar_category', ['name', 'parent_id'])
