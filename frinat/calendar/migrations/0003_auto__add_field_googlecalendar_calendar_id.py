...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoogleCalendar.calendar_id'
        db.add_column(u'calendar_googlecalendar', 'calendar_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoogleCalendar.calendar_id'
        db.delete_column(u'calendar_googlecalendar', 'calendar_id')
