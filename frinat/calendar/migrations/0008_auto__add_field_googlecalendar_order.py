...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoogleCalendar.order'
        db.add_column(u'calendar_googlecalendar', 'order',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoogleCalendar.order'
        db.delete_column(u'calendar_googlecalendar', 'order')
